...
$item1 = "entregas_id";
$pedidosAsignados = ControladorEntregas::ctrMostrarPedidosEntrega($item1,$this->id);

//MI CICLO PARA RECORRER TODOS LOS PEDIDOS DE LA ENTREGA
foreach ($pedidosAsignados as $key => $value) {

  //TRAEMOS LA INFORMACIÓN DE LOS PEDIDOS
  $itemPedido = "numero";
  $valorPedido = $value["numero"];
  ...
  //TRAEMOS LA INFORMACIÓN DEL AFILIADO
  $itemAfiliado = "clave";
