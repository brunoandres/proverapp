            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Último Ingreso</b> <a class="pull-right"><strong><?php echo $_SESSION["ultimoIngreso"]; ?></strong></a>
                </li>
                <li class="list-group-item">
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  ...
                  <div class="row margin-bottom">
                    <div class="col-sm-6">
                      <img class="img-responsive" src="vistas/dist/img/photo1.png" alt="Photo">
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="col-sm-6">
                          <img class="img-responsive" src="vistas/dist/img/photo2.png" alt="Photo">
                          <br>
                          <img class="img-responsive" src="vistas/dist/img/photo3.jpg" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <img class="img-responsive" src="vistas/dist/img/photo4.jpg" alt="Photo">
                          <br>
                          <img class="img-responsive" src="vistas/dist/img/photo1.png" alt="Photo">
                        </div>
                        <!-- /.col -->
