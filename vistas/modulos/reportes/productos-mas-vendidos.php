...
$cantidad = sizeof($productos);

$colores = array("red","green","yellow","aqua","purple","blue","cyan","magenta","orange","gold");

$totalPedidos = ControladorProductos::ctrMostrarSumaPedidos();
...
<div class="box box-default">
	...
	<div class="box-body">
      	...
      	<div class="row">
            ...
            if(!$productos[$i]['entregados'] == null){
    ...
    <div class="box-footer no-padding">
		...
		<ul class="nav nav-pills nav-stacked">
			 ...
			 <?php
              ...
              if(!$productos[$i]['entregados'] == null){
                $entregados = $productos[$i]['entregados'];
                echo '<li>
						 ...
						 '.ceil($entregados*100/ $totalPedidos["total"]).'%
						 </span>
